 ...
 *
 * Determines whether a rule is eligible for a given stay date.
 */

import type { EngineRule } from "@/types/domain";
import { hotelStayDateIsoWeekday } from "./timezone";

/**
 * Returns true if the rule's scope filters match the given stay date.
 *
 * Checks: is_active, non-empty signal/affected sets, date window
 * (literal or annual), and DOW mask in the hotel's timezone.
 */
 ...
 * Month-day uses the stay date string (hotel civil date), including Feb 29 (229).
 */
