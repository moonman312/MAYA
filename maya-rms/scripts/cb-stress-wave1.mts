...
const COUNTS: Record<string, number> = {
  "2026-10-05": 3, "2026-08-17": 1, "2026-10-12": 3, "2026-10-15": 3, "2026-10-19": 3, "2026-10-26": 4,
};
...
for (const [rt, name] of [[Q, "queen"], [K, "king"]] as const) {
  ...
  const wantLadder = -(Math.round(base * 10) / 100); // −10% of base, cents
...
const push = await pushRatesForHotel(admin, HOTEL, adapter);
