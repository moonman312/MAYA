-- ============================================================================
-- WARNING: OUTDATED -- DO NOT RUN THIS FILE.
--
-- This is the old fresh-install base schema and it has drifted from the real
-- database. Running it will break an existing install.
-- 02_supabase_schema.sql is the source of truth for all DDL.
--
-- Every statement below is commented out so the file is a no-op if someone
-- runs it anyway. Kept for reference only.
-- ============================================================================
